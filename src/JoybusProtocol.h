...
namespace JoybusProtocol
{
    static inline U8 GetCommandTxLength( U8 command )
    {
        ...
        case JOYBUS_CMD_N64_EEPROM_READ:
            return JOYBUS_CMD_N64_EEPROM_READ_TX;
        case JOYBUS_CMD_N64_EEPROM_WRITE:
            return JOYBUS_CMD_N64_EEPROM_WRITE_TX;
        case JOYBUS_CMD_N64_RTC_INFO:
            return JOYBUS_CMD_N64_RTC_INFO_TX;
        case JOYBUS_CMD_N64_RTC_READ:
            return JOYBUS_CMD_N64_RTC_READ_TX;
        case JOYBUS_CMD_N64_RTC_WRITE:
            return JOYBUS_CMD_N64_RTC_WRITE_TX;
    ...
    static inline U8 GetCommandRxLength( U8 command )
    {
        ...
        case JOYBUS_CMD_N64_EEPROM_READ:
            return JOYBUS_CMD_N64_EEPROM_READ_RX;
        case JOYBUS_CMD_N64_EEPROM_WRITE:
            return JOYBUS_CMD_N64_EEPROM_WRITE_RX;
        case JOYBUS_CMD_N64_RTC_INFO:
            return JOYBUS_CMD_N64_RTC_INFO_RX;
        case JOYBUS_CMD_N64_RTC_READ:
            return JOYBUS_CMD_N64_RTC_READ_RX;
        case JOYBUS_CMD_N64_RTC_WRITE:
            return JOYBUS_CMD_N64_RTC_WRITE_RX;
        case JOYBUS_CMD_N64_KEYBOARD_READ:
